...
<div>
  <div class="login-container">
    <div class="login-box">
      <div style="font-weight: bold; font-size: 24px; text-align: center; margin-bottom: 30px; color: #1450aa">员 工 注 册</div>
      ...
      <div style="text-align: right;">
        已有账号？ <a href="javascript:void (0)" @click="router.push('/login')" style="color: red;">返回登录</a>
      </div>
    </div>
