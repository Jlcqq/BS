<template>
    <div>
      ...
      <div class="card" style="margin-top: 5px" >
        ...
        <el-table :data="data.tableData"  min-height="250" style="width: 100%">
          <el-table-column label="图片">
            <template #default="scope">
              <el-image :src="scope.row.fileimg" style="width: 300px; height: 150px;"></el-image>
            </template>
          </el-table-column>
          <el-table-column label="URL" prop="url"></el-table-column>
          <el-table-column prop="address" label="操作" >
            <template #default="scope">
              <el-button type="warning" size="small" plain @click="Edit(scope.row)">编辑</el-button>
